...
const MarketingData = {
  ...
  whatsappTemplates: {
    ...
    reciboAcerto: "📝 *RECIBO DE ACERTO DE CONSIGNADO - CONECTA JOIAS* 📝\n\n*Revendedora:* {revendedora}\n*Data do Acerto:* {data_acerto}\n\n---------------------------------\n📊 *Resumo do Lote (Ciclo):*\n- Peças Consignadas (Inicial): {qtd_consignada} unid.\n- Peças Devolvidas: {qtd_devolvida} unid.\n- Peças Perdidas/Danos: {qtd_perdida} unid.\n- Peças Efetivamente Vendidas: {qtd_vendida} unid.\n\n💰 *Fechamento Financeiro:*\n- Faturamento Total Bruto: *R$ {valor_bruto}*\n- Comissão Base ({comissao_porc}%): *R$ {valor_comissao}*\n- (-) Desconto Perdas/Danos: *R$ {valor_desconto_perda}*\n- (=) Comissão Líquida Devida: *R$ {valor_comissao_liquida}*\n\n💳 *Meios de Recebimento das Vendas:*\n- Dinheiro Físico (com a Revendedora): *R$ {recebido_dinheiro}*\n- Pix/Cartão/Link (caído direto para a Gestora): *R$ {recebido_pix_cartao}*\n- Dinheiro Físico já entregue para a Gestora? *{dinheiro_entregue}*\n\n---------------------------------\n⚡ *RESOLUÇÃO DE CONTAS (QUEM PAGA QUEM?)* ⚡\n{texto_quem_paga_quem}\n\n*Motivo:* {explicacao_detalhada}\n---------------------------------\n\nAgradecemos imensamente pela nossa parceria de sucesso! Que as próximas vendas sejam ainda mais abençoadas! 💎🙌✨"
  }
};
